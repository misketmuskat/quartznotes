...
- **Course Contents**:  
	...
	We will also consider the interplay between data and knowledge, highlighting the importance of perspectivity, contextualisation and implicit knowledge in discourse analysis. The lecture will show how these factors influence the production and interpretation of discourse in different contexts.
...
* **Language as Data 2**
	* [x] Ducard: Language and the Game of Chess
	* [x] AJ Greimas: About Games
* **Michel Foucault**
	* [x] Foucault - The Subject and Power
...
* **Critical Linguistics and Critical Discourse Analysis**
	* [x] Michael Billig: Nominalization and Critical Linguistics
	* [x] Jan Blommaert: Critical Discourse Analysis
	* [ ] Machin and Mayr: How to do CDA
* **Conceptual History**
	* [x] Reinhart Koselleck: Crisis
...
[[micronotes-data-and-discourse]]
## Lecture Notes
- [ ] [[week1-introduction-data-discourse]]
- [ ] [[week2-what-is-discourse-analysis]]
- [x] [[week3-language-as-data-1]]
- [x] [[week4-language-as-data-2]]
- [x] [[week5-michel-foucault]]
- [ ] [[week6-language-as-social-practice]]
- [ ] [[week7-critical-linguistics-and-critical-discourse-analysis]]
- [ ] [[week8-conceptual-history]]
- [ ] [[week9-data-and-knowledge-1]]
- [ ] [[week10-data-and-knowledge-2-implicit-knowledge]]
- [ ] [[week11-data-and-knowledge-3-empty]]
- [ ] [[week12-discourse-analysis-in-philology-and-social-sciences]]
- [ ] [[week13-corpus-approaches-to-discourse-1]]
- [ ] [[week14-corpus-approaches-to-discourse-2]]
